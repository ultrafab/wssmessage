...
var log = logger.GetLogger("activity-sendWSSMessage")

// WssMsgActivity is a stub for your Activity implementation
type WssMsgActivity struct {
	metadata *activity.Metadata
}

// NewActivity creates a new WssMsgActivity
func NewActivity(metadata *activity.Metadata) activity.Activity {
	return &WssMsgActivity{metadata: metadata}
}

// Metadata implements activity.Activity.Metadata
func (a *WssMsgActivity) Metadata() *activity.Metadata {
	return a.metadata
}

// Eval implements activity.Activity.Eval - Sends a message to a WebSocket enabled server like TIBCO eFTL
func (a *WssMsgActivity) Eval(context activity.Context) (done bool, err error) {
